...
//Resources
const APP_ID = 'amzn1.ask.skill.f0db2ba7-0082-43c4-9a8c-aad4b0934b01';      //Alexaサービス側ID
const F_VOICE = 'https://pichi.net/skill/nayoro/ActivityVOICEAfter.mp3';    //デモ用音声（30秒）
const F_TITLELOGO = 'https://pichi.net/skill/nayoro/smartkenpo.png';        //起動時ロゴ
const F_NAYOROU = 'https://pichi.net/skill/nayoro/nayorou.png';             //運動中画像
const F_OTSUKARE = 'https://pichi.net/skill/nayoro/nayorou_otsukare.png';   //終了時画像
